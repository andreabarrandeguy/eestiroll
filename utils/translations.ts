...
export const translations = {
    en: {
        ...
        feedbackInfoCorrection: "Think the AI's correction is wrong, or missed something? Share it below.",
    ...
    es: {
        ...
        feedbackInfoCorrection: '¿Te parece que la corrección de la IA está mal, o le faltó algo? Escribilo acá abajo.',
    ...
    ru: {
        ...
        feedbackInfoCorrection: 'Кажется, что исправление ИИ неверное или что-то упустило? Напишите здесь.',
